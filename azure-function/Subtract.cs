...
namespace MathPlugin
{
    public class Subtract
    {
        ...
        [OpenApiParameter(name: "number1", Description = "The first number", Required = true, In = ParameterLocation.Query)]
        [OpenApiParameter(name: "number2", Description = "The second number", Required = true, In = ParameterLocation.Query)]
        [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "text/plain", bodyType: typeof(string), Description = "Returns the subtract result of the two numbers.")]
        ...
        public HttpResponseData Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post")] HttpRequestData req)
        {
            ...
            if (result1 && result2)
            {
                ...
                _logger.LogInformation($"Subtract function processed a request. Result: {result}");
