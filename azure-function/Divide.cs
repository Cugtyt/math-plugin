...
namespace MathPlugin
{
    public class Divide
    {
        ...
        [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "text/plain", bodyType: typeof(string), Description = "Returns the divided result of the two numbers.")]
        ...
        public HttpResponseData Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post")] HttpRequestData req)
        {
            ...
            if (result1 && result2)
            {
                ...
                _logger.LogInformation($"Divide function processed a request. Result: {result}");
